...
<head>
    ...
    @vite(['resources/css/app-base.css', 'resources/js/app.js', 'resources/css/graduate__result.css', 'resources/css/responesive-tablet.css', 'resources/css/responsive-mobile.css'])
    {{--  --}}
</head>
...
<body style="overflow:hidden">
    <div class="hero">
        <div class="graduation">
            ...
            <div class="section__details section">
                ...
                <div class="section__details__content">
                    ...
                    <div class="content__qr__graduate">
                        ...
                        <img src="https://chart.googleapis.com/chart?cht=qr&chl={{ $student->student_id }}&choe=UTF-8&chs=150x150&chld=H|0" style="height: 162px; width: 162px; border: 1px solid black; padding: 12px; border-radius: 5px;">
                    </div>
                </div>
